...
**2. Lesen und Inventar anlegen.** Vor dem ersten neuen Satz: Was will der Text, wer liest ihn, was muss er wissen? Dann eine Liste der Substanz: alle Zahlen, Namen, Daten, Zitate, Quellen; jede Begründung („weil“, „da“, „deshalb“); jedes Beispiel; jede echte Einschränkung; jede Wertung des Autors; jede Formulierung, die nach ihm klingt. Das Original legst du immer als Datei ab (die Messung in Schritt 5 braucht es). Das Inventar schreibst du ab etwa 300 Wörtern ebenfalls in eine Datei, damit es beim Abgleich in Schritt 6 nicht aus dem Gedächtnis kommen muss; darunter reicht es im Kopf.
...
Das Skript meldet **Verstöße** (Satzlänge, Floskeln, Nominal- und Passivdichte, Streckverben, fehlende Zahlen und Zitate, Überkürzung) und **Hinweise** (Passiv-Verdacht, Modewörter im Kontext, Rhythmus, falsche Handlungsträger, Namen). Verstöße behebst du und misst erneut; nach spätestens zwei Nachbesserungsrunden ist Schluss. Hinweise prüfst du mit Redakteursblick, ohne Pflicht zur erneuten Messung: Ein Fachbegriff, ein begründetes Passiv, ein bewusst gesetzter Rhythmus, ein Wort des Autors dürfen bleiben. Bleibt ein Verstoß, den du für richtig hältst, nenne ihn in der Notiz mit Grund. Wortzahlen in der Notiz sind die des Skripts (es zählt Wörter mit Buchstaben, keine Ziffern und kein Markdown).

**6. Stilprüfung und Substanzabgleich.** Erst die acht Fragen der Stilprüfung am Ende von `references/stilistik.md`, Absatz für Absatz: Textsorte erkennbar, Sätze verkettet, Vorfeld wechselnd, Längen gestreut, ein konkretes Datum je Absatz, Konnektoren nur mit Logik, jedes Subjekt kann tun, was sein Verb behauptet, Stimme des Autors hörbar. Jedes Nein ist eine Stelle zum Umbauen; nach dem Umbau eine Kontrollmessung, die nicht als Nachbesserungsrunde zählt. Dann das Inventar aus Schritt 2: Fehlt etwas, füge es wieder ein, auch wenn der Text dadurch länger wird. Klingt der Text nach einem Protokoll, hole eine erhaltene Formulierung des Originals zurück.
